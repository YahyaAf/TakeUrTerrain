...
<div class="bg-gray-50 py-8 px-6 rounded-lg shadow-sm max-w-3xl mx-auto mt-6">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">
            <span class="text-blue-500">#</span> Create New Role
        </h1>
        ...
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input type="text" name="name" id="name" class="pl-10 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md py-3" 
                           placeholder="e.g., editor, moderator, analyst" required>
                </div>
                <p class="mt-2 text-sm text-gray-500">Choose a descriptive name that reflects the role's responsibilities</p>
            ...
            <div class="mb-6">
                ...
                <div class="flex justify-between items-center mb-3 px-2">
                    ...
                    <span id="permissionCounter" class="text-sm text-gray-500">0 selected</span>
                </div>
    ...
    <div class="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-4">
        ...
        <ul class="mt-2 text-sm text-blue-700 list-disc list-inside space-y-1">
            <li>Use descriptive names that reflect the role's responsibilities</li>
            <li>Group related permissions into logical roles</li>
            <li>Follow the principle of least privilege</li>
            <li>Consider creating role hierarchies for complex systems</li>
        </ul>
    </div>
</div>
