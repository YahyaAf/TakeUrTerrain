            ...
            <div class="p-6">
                ...
                <div class="flex justify-end space-x-3 pt-6 mt-6 border-t border-indigo-50">
                    <a href="{{ route('sponsors.index') }}" 
                        class="p-3 bg-white text-indigo-700 border border-indigo-300 rounded-lg hover:bg-indigo-50 shadow-sm transition-all duration-200 flex items-center justify-center tooltip" 
                    ...
                    <a href="{{ route('sponsors.edit', $sponsor->id) }}" 
                        class="p-3 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center tooltip"
                        title="Modifier">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <form action="{{ route('sponsors.destroy', $sponsor->id) }}" method="POST" class="inline">
                        ...
                        <button type="submit" 
                                ...
                                class="p-3 bg-red-500 text-white rounded-lg hover:bg-red-600 shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center tooltip"
                                title="Supprimer">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
