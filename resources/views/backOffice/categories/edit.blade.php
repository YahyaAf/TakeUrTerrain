...
<div class="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen">
    <div class="max-w-2xl mx-auto">
        ...
        <div id="successMsg" class="hidden mb-4 text-green-600 font-medium"></div>

        <div id="errorMsg" class="hidden mb-4 text-red-600 font-medium"></div>

        <div class="bg-white shadow-lg rounded-xl p-8 border border-indigo-100 transition-all duration-300">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function(e) {
        ...
        .catch(error => {
            errorMsg.textContent = error.message || 'Une erreur est survenue lors de la mise à jour.';
