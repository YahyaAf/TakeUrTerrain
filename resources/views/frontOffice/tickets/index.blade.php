                        ...
                        <div class="flex flex-col md:flex-row">
                            <div class="md:w-2/5 relative group">
                                {{-- @if ($ticket->terrain && $ticket->terrain->photo) --}}
                                    <img src="{{ asset('storage/' . $ticket->reservation->terrain->photo) }}" class="w-full h-64 md:h-full object-cover" alt="Photo du terrain">
                                {{-- @else --}}
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-start p-4">
                                    <span class="text-white font-medium">{{ $ticket->reservation->terrain->name ?? 'Nom terrain inconnu' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="md:w-3/5 p-6 md:p-8">
                                ...
                                <div class="flex justify-between items-start mb-6">
                                    <div>
                                        <h3 class="text-2xl font-bold text-gray-800">{{ $ticket->reservation->terrain->name ?? 'Nom terrain inconnu' }}</h3>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-6">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-emerald-700">{{ $ticket->reservation->terrain->adresse ?? 'Non définie' }}</div>
                                        </div>
                                    </div>
